// Level 7 Main Function

G.F.loadLevel7 = function () { 
    
    // assigns new AI function to G.B.level7.AI
    this.AI = G.F.mainAI;
    ...
    // adds gole0 to viewport with holeAI
    ...
    // adds bridge0 to viewport with bridgeAI
...
// creates and loads level7 block which starts the level
$(document).ready(function() {
    G.makeBlock('level7', G.F.loadLevel7).loadBlock('level7');
});
