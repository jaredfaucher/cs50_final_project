// Level 4 Main Function

G.F.loadLevel4 = function () { 
    
    // assigns new AI function to G.B.level4.AI
    this.AI = G.F.mainAI;
...
// creates and loads level4 block which starts the level
$(document).ready(function() {
    G.makeBlock('level4', G.F.loadLevel4).loadBlock('level4');
});
